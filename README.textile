...
Developed by Christopher Imrie, http://www.christopherimrie.com<br/>
This field type is inspired by LG Member list (http://leevigraham.com/cms-customisation/expressionengine/lg-member-list/)<br/>

h2. Requirements

* ExpressionEngine 2.0 PB
...
*Parameters*
* <code>get</code> - Accepts field names of the _exp_members_ and _exp_member_groups_

The field type supports single tag and tag pairs, depending on whether you want more than one piece of member data at any one time.
